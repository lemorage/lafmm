...
│   │   ├── SPY.csv, QQQ.csv    # leaders
│   │   ├── DIA.csv, IWM.csv    # tracked
...
└── skills/                     # agent workflows (Anthropic skill format)
```
...
cache/ is regenerated by the sync-lafmm-cache skill. Never edit it directly. When data/ changes, run the sync-lafmm-cache skill to rebuild cache/.
